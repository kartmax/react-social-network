...
const USERS_REDUSER = (state = initialState, action) => {
   switch(action.type) {
      ...
      case SET_CURRENT_PAGE: {
         return{ ...state, currentPage: action.idxPage };
      }
